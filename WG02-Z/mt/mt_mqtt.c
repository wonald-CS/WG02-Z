...
static void mt_mqtt_setLinkID(unsigned char *p);
static void mt_mqtt_setUsername(unsigned char *p);
static void mt_mqtt_setServerIp(unsigned char *p);
static void mt_mqtt_setServerPort(unsigned char *p);
static void mt_mqtt_setSubTopic(unsigned char *p);
static void mt_mqtt_setPubTopic(unsigned char *p);
